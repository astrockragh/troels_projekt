...
data_posi = pd.read_csv("Data-Epidemiologiske-Rapport-23092020-52lv/Municipality_cases_time_series.csv", sep=';', thousands='.', index_col=0)
data_test = pd.read_csv("Data-Epidemiologiske-Rapport-23092020-52lv/Municipality_tested_persons_time_series.csv", sep=';', thousands='.', index_col=0)
...
Ntest_aarhus = data_test.loc["2020-03-01":"2020-09-22"][area_aarhus].values.sum(axis=1)
eNtest_aarhus = np.sqrt(Ntest_aarhus)

Nposi_cph = data_posi.loc["2020-03-01":"2020-09-22"][area_cph].values.sum(axis=1)
Ntest_cph = data_test.loc["2020-03-01":"2020-09-22"][area_cph].values.sum(axis=1)
